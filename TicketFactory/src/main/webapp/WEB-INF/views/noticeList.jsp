...
<div class="wrap_topmargin">
	...
	<table style="margin:auto;border:1px solid #d8d8d8;background-color:#ffffff;">
							...
							<td style="background:url('/ticketfactory/resources/image/icon_table_center.gif') repeat-x;">
								<table cellspacing="0" style="width:100%;">
									<tr>
										...
										<td class="myTable" align="center" style="width:80px;">작성일</td>
									</tr>
								</table>
							</td>
							<td style="width:3px;">
										...
										<td valign=top align=center>
											...
											<c:forEach var="dto" items="${lists}">
												<tr height="40" class="listCss">
													<td width="55" align="center">${dto.notiNum }</td>
													<td width="1"></td>
													<td width="400" align="left" style="padding-left:10px;">
													<a href="${articleUrl}&notiNum=${dto.notiNum}">
													${dto.notiSubject }</a></td>
													<td width="1"></td>
													<td width="90" align="center">${dto.notiCreated }</td>
												</tr>
											</c:forEach>
												<tr>
		...
		<%-- 	<!-- 글쓰기버튼 -->
			<c:if test="${sessionScope.loginDto.userId == 'shtm0559' }">
			<div style="padding:1px 1px 15px 15px; text-align: right;  padding-right: 44px;">
				<a href='<%=cp%>/notiCreated.action?pageNum=${currentPage}'>
			...
			<div style="text-align:right; padding:0 45px 15px 15px;"></div>
