	    ...
	    <div id="adside">
			<div id="show_content_session_1">						
				...
				<div id="show_content_session_2">
					...
					<font style=""><a href="tomorrow.action?genre=1" id="genre1">연극</a></font>
					</p>
					<p onclick="">
					<img class="icon_dot" 
					src="/ticketfactory/resources/image/icon_dot.png">
					<font style=""><a href="tomorrow.action?genre=2" id="genre2">뮤지컬</a></font>
					</p>
					<p onclick="">
					<img class="icon_dot" 
					src="/ticketfactory/resources/image/icon_dot.png">
					<font style=""><a href="tomorrow.action?genre=3" id="genre3">클래식</a></font>
					</p>
					<p onclick="">
					<img class="icon_dot" 
					src="/ticketfactory/resources/image/icon_dot.png">
					<font style=""><a href="tomorrow.action?genre=4" id="genre4">국악</a></font>
					</p>
					<p onclick="">
					<img class="icon_dot" 
					src="/ticketfactory/resources/image/icon_dot.png">
					<font style=""><a href="tomorrow.action?genre=5" id="genre5">오페라</a></font>
					</p>
				...
				<div id="show_content_session_3">
					...
					<div id="show_content_session_2">
						...
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=6" id="genre6">서울</a></font>
						</p>
						<p onclick="">
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=7" id="genre7">경기</a></font>
						</p>
						<p onclick="">
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=8" id="genre8">충청</a></font>
						</p>
						<p onclick="">
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=9" id="genre9">경상</a></font>
						</p>
						<p onclick="">
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=10" id="genre10">전라</a></font>
						</p>
						<p onclick="">
						<img class="icon_dot" 
						src="/ticketfactory/resources/image/icon_dot.png">
						<font style=""><a href="tomorrow.action?genre=11" id="genre11">그외지역</a></font>
						</p>
					</div>
				</div>
						...
						<tr>
							...
							text-align: right; width: 500px; padding-right: 8px;">
								<img class="icon_dot" 
									...
									<a href="tomorrow.action?genre=${genre }&order=price"><font style="color:#FF007F; font-weight: bold; font-size: 11pt;"id="bottom_price_list">최저가순</font></a>
							</td>
							<td style="text-align: center; width: 80px">
								<img class="icon_dot" 
									src="/ticketfactory/resources/image/sort_tri_off.png"
									width="5px" height="10px" id="grade_list_img">
									<a href="tomorrow.action?genre=${genre }&order=star"><font style="color:#FF007F; font-weight: bold; font-size: 11pt;" id="grade_list">평점순</font></a>
							</td>
						</tr>
						</table>
					</div>
				...
				<table width="100%">
							...
							<c:if test="${empty show }">
								<c:if test="${empty area }">
									...
									<tr><td width="100%" align="center" style="font-size: 12px;">${tomorrow }에 예매가능한 티켓이 없습니다.</td></tr>
								</c:if>
							</c:if>
									...
									<c:if test="${not doneLoop }">
										...
										<td width="185px" align="center"> 
											...
											onclick="go('${dto.showId}','${dto.showName }');">
												...
												<tr>
													<td colspan="2"
														style="height: 45px; font-weight: bold; font-size: 11pt;">${dto.showName }&nbsp;
												...
												<tr>
													<td colspan="2"
														style="height: 15px; font-weight: bold; font-size: 15pt;">
														<c:choose>
												...
												<tr>
													<td style="height: 30px; font-size: 12pt; font-weight:bold; color: blue;">
													<span>60%</span>
													</td>
													<td align="right"
