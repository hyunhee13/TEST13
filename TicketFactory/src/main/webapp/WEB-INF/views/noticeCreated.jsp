...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp%>/notiCreated_ok.action";
		f.submit();
...
<div class="wrap_topmargin">
	...
	<table style="margin:auto;border:1px solid #d8d8d8;background-color:#ffffff;">
			  ...
			  <td>
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr style="border:1px solid #dedede; height:40px;">
						...
						<input name='notiSubject' type='text' class="input_New" 
					...
					<tr style="border:1px solid #dedede; height:40px;">
						...
						width: 580px; padding-left: 7px; padding-top: 5px;"></textarea></td>
					</tr>
		...
		<div style="margin: 15px 0px 5px 260px;">
			...
			onclick="document.myForm.notiSubject.focus();"/>
