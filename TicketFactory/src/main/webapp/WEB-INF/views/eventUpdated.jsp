...
<script src="<%=cp%>/resources/editor/ckfinder/ckfinder.js"></script>
...
/* 		str = f.upload.value;
		...
		f.action = "<%=cp%>/eventUpdated_ok.action?pageNum=${pageNum}";
		f.submit();
									  ...
									  <td>
										<table width="100%" cellpadding="0" cellspacing="0">
											...
											<tr style="border:1px solid #dedede; height:40px;">
												...
												maxlength="100" style="width:580px;" value="${dto.ebTitle}"></td>
											</tr>
											...
											<tr style="border:1px solid #dedede; height:40px;">
												...
												maxlength="100" style="width:580px;" value="${dto.ebSubject }"></td>
											</tr>
											...
											<tr style="border:1px solid #dedede; height:40px;">
												...
												maxlength="100" style="width:580px;" value="${dto.ebTitleContent}"></td>
											</tr>
											...
											<tr style="border:1px solid #dedede; height:40px;">
												...
												<td style="padding:5px 0 5px 10px;">
													<textarea rows="200" cols="80" id="ebContent" name="ebContent" class="ckeditor">
													${dto.ebContent}</textarea>
														<script>
